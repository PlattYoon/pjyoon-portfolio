...
Files you won't modify:
   ...
   elem-char.c0   - Defines list elements to chars for testing
...
Files you will modify:
 basic-tests.c0   - Test the representation invariants for the various parts
                    of this assignment as you implement them
...
==========================================================
Compiling and running the basic tests
   % cc0 -d -W -o basic-tests gapbuf.c0 dll_pt.c0 tbuf.c0 basic-tests.c0
   % ./basic-tests

Compiling and running the gapbuf tests:
   % cc0 -d -W -w -o gapbuf-test gapbuf.c0 gapbuf-test.c0
   % ./gapbuf-test 16
...
Compiling and running the dll_pt tests:
   % cc0 -d -W -w -o dll_pt-test elem-char.c0 dll_pt.c0 dll_pt-test.c0
   % ./dll_pt-test
...
Compiling and running the tbuf tests:
   % cc0 -d -W -w -o tbuf-test gapbuf.c0 dll_pt.c0 tbuf.c0 tbuf-test.c0
   % ./tbuf-test
...
Compiling and running the E0 editor:
   % cc0 -d -W -w -o E0 gapbuf.c0 dll_pt.c0 tbuf.c0 lovas-E0.c0
   % ./E0

==========================================================

Submitting from the command line on andrew (CHECKPOINT):
   % autolab122 handin editorcheck gapbuf.c0
then display autolab's feedback by running:
   % autolab122 feedback editorcheck

Submitting from the command line on andrew (FINAL):
   % autolab122 handin editor gapbuf.c0 dll_pt.c0 tbuf.c0
then display autolab's feedback by running:
   % autolab122 feedback

Creating a tarball to submit with autolab.andrew.cmu.edu web interface:
   % tar -czvf handin.tgz gapbuf.c0 dll_pt.c0 tbuf.c0
